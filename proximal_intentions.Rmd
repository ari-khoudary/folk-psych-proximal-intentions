...
assignBin <- function(df) {
  ifelse(df$rating == 1, 'Yes',
  ifelse(df$rating==2, 'Yes', 
  ifelse(df$rating==3, 'Yes',
  ifelse(df$rating==5, 'No',
  ifelse(df$rating==6, 'No',
  ifelse(df$rating==7, 'No', NA))))))
}
```
